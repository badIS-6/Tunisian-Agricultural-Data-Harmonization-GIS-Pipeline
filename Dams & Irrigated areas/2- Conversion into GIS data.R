...
DATA_FOLDER <- "/home/badiss/Desktop/Internship 2026/Dams & Irrigated areas/Clean data"
OUTPUT_FOLDER <- "/home/badiss/Desktop/Internship 2026/Dams & Irrigated areas/GIS Layers"
...
for (f in files) {
  ...
  for (col in cols) {
    ...
    new_data[[col]] <- vec[new_data$region_id]
  }
